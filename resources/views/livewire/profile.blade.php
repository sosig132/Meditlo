...
<script>
    ...
    //     // Listen for custom event to trigger file upload
    //     window.addEventListener('triggerFileUpload', function () {
    //         console.log("Damn");
    //         triggerFileUpload();
    //     });

    //     // Direct click on overlay to trigger file upload
    //     document.getElementById('overlay').addEventListener('click', function() {
    //         console.log("Damn");
    //         triggerFileUpload();
    //     });

    //     // Direct click on profile image to trigger file upload
